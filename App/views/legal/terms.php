...
<head>
  ...
  <link rel="stylesheet" href="../../../assets/CSS/privacy-term.css">
  <title>Terms & Condition | Hagurash</title>
</head>
<body>
  <header>
    <h1>Terms and Conditions for Hagurash</h1>
  </header>
  <main>
    <h2>Terms and Conditions</h2>
    <p>
      Last updated:<time datetime="2023-12-12"> December 12, 2023</time><br><br>
      Please read this terms and conditions before using our service
    </p>
    ...
    <p>
      ...
      <br><br>When You access the Service by or through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers and other diagnostic data.
    ...
    <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. <br><br>We use both Session and Persistent Cookies for the purposes set out below:</p>
    
    <ul>
      <li>
        <span>Necessary Essential Cookies</span><br><br>
        Type: Session Cookies <br><br>
        Adiminstred by:US <br><br>
        Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.
      </li>
      <li>
        <span>Cookies Policy / Notice Acceptance Cookies</span><br><br>
        Type: Persistent Cookies <br><br>
        Adiminstred by:US <br><br>
        Purpose: These Cookies identify if users have accepted the use of cookies on the Website.
      </li>
      <li>
        <span>Functionality Cookies</span><br><br>
        Type: Persistent Cookies <br><br>
        Adiminstred by:US <br><br>
    ...
    <p>The Company may use Personal Data for the following purposes: <br></p>
    <ul>
    ...
    <h3>Contact Us</h3>
    <p>
      If you have any questions about this Terms and Condition, You can contact us: <br><br>
      By visiting this page on our website:
      <a href="contact.html">http://www.haguash.com/contact</a>
    </p>
  </main>
